...
add_action('wp_head','AF_custom_css');
function AF_custom_css() {
	echo "\r\n\r\n\r\n<!-- Generated by Arabic Font -->\r\n";
	echo "<style type='text/css'>";
	echo get_option('AF_defaultcssclass')." {font-family: ".get_option('AF_fontfamily')."; font-size: ".get_option('AF_fontsize')."px; direction: rtl; line-height: ".get_option('AF_lineheight')."px; text-align: ".get_option('AF_textalign').";}";
	echo get_option('AF_customcss');
	echo "</style>\r\n\r\n\r\n";
}
